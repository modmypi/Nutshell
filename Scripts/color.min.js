...
*/
var Color=function(b){var d=!1;"object"===typeof b&&Color.isColor(b)&&(this.red=b.red,this.green=b.green,this.blue=b.blue,d=!0);if(!d){"#"==b.charAt(0)&&(b=b.substr(1));var b=b.replace(/ /g,"").toLowerCase(),c=Color[b];c&&(this.red=c.red,this.green=c.green,this.blue=c.blue,d=!0);if(!d){d=[{re:/^rgb\((\d{1,3}),\s*(\d{1,3}),\s*(\d{1,3})\)$/,example:["rgb(123, 234, 45)","rgb(255,234,245)"],process:function(a){return[parseInt(a[1]),parseInt(a[2]),parseInt(a[3])]}},{re:/^(\w{2})(\w{2})(\w{2})$/,example:["#00ff00",
"336699"],process:function(a){return[parseInt(a[1],16),parseInt(a[2],16),parseInt(a[3],16)]}},{re:/^(\w{1})(\w{1})(\w{1})$/,example:["#fb0","f0f"],process:function(a){return[parseInt(a[1]+a[1],16),parseInt(a[2]+a[2],16),parseInt(a[3]+a[3],16)]}}];for(c=0;c<d.length;c++){var a=d[c].process,e=d[c].re.exec(b);e&&(a=a(e),this.red=a[0],this.green=a[1],this.blue=a[2])}}}this.red=0>this.red||isNaN(this.red)?0:255<this.red?255:this.red;this.green=0>this.green||isNaN(this.green)?0:255<this.green?255:this.green;
this.blue=0>this.blue||isNaN(this.blue)?0:255<this.blue?255:this.blue;this.toRGB=function(){return Color.rgb(this)};this.toHex=function(){return Color.hex(this)};this.toHtml=function(){return Color.html(this)}};
(function(){var b={isColor:function(a){return a&&"number"===typeof a.red&&"number"===typeof a.green&&"number"===typeof a.blue},areEqual:function(a,b){return a.red===b.red&&a.green===b.green&&a.blue===b.blue},rgb:function(a){return"rgb("+a.red+", "+a.green+", "+a.blue+")"},hex:function(a){return("00000"+(65536*a.red+256*a.green+a.blue).toString(16)).slice(-6)},html:function(a){return"#"+Color.hex(a)},aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"00ffff",aquamarine:"7fffd4",azure:"f0ffff",beige:"f5f5dc",
...
whitesmoke:"f5f5f5",yellow:"ffff00",yellowgreen:"9acd32"},d;for(d in b){var c=b[d];Color[d]="string"===typeof c?new Color(c):c}})();